...
for t = 1:m
    a_1 = [1; X(t, :)'];  % 401 * 1, bias unit added
    z_2 = Theta1 * a_1;  % 25 * 1
    a_2 = [1; sigmoid(z_2)];  % 26 * 1, bias unit added
    z_3 = Theta2 * a_2;  % 10 * 1
    a_3 = sigmoid(z_3);  % 10 * 1, the hypothesized output
    y_1 = zeros(num_labels, 1);  % 10 * 1
    y_1(y(t)) = 1;  % 10 * 1, the actual output
    
    J = J + sum(-y_1 .* log(a_3) - (1 - y_1) .* log(1 - a_3));
    
    delta_3 = a_3 - y_1;  % 10 * 1
